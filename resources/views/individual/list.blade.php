                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-actions text-center">
                            ...
                            <a href="{{url('/application/add_application')}}/{{$ind->id}}" rel="tooltip" class="btn btn-info" data-original-title="Add Application Data" title="">
                                <i class="fa fa-file-text-o" aria-hidden="true"></i>
                                <div class="ripple-container"></div>
                            </a>
                            @endif
                            <a href="{{url('/individual/view')}}/{{$ind->id}}" rel="tooltip" class="btn btn-success" data-original-title="View Farmer" title="">
                                <i class="fa fa-eye" aria-hidden="true"></i>
                                <div class="ripple-container"></div>
                            </a>
                            <a href="{{url('/individual/edit')}}/{{$ind->id}}" rel="tooltip" class="btn btn-warning" data-original-title="Edit Farmer" title="">
