...
<div class="col-md-12" id="individual-list">
    ...
    <div class="card">
        ...
        <div class="card-content table-responsive">
            <table id="list_table" class="table table-hover ind_table">
                <thead class="">
                    <th>No</th>
                    <th>Picture</th>
                    <th>Name</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="list-avatar">
                                <a href="{{url('/individual/view')}}/{{$ind->id}}" target="_blank">
                                    <img class="img" src="{{$ind->avatar? $ind->avatar: ''}}" alt="Avatar"/>
                                </a>
                            </div>
                        </td>
                        <td><a href="{{url('/individual/view')}}/{{$ind->id}}" target="_blank">{{$ind->name}}@if($ind->alias) <i>({{$ind->alias}})</i>@endif</a></td>
                        ...
                        <td class="td-actions text-center">
                            @if($ind->applications()->count() <= 0)
                            <a href="{{url('/application/add_application')}}/{{$ind->id}}" rel="tooltip" class="btn btn-info" data-original-title="Add Application Data" title="" target="_blank">
                                <i class="fa fa-file-text-o" aria-hidden="true"></i>
                                <div class="ripple-container"></div>
                            </a>
                            @endif
                            <a href="{{url('/individual/view')}}/{{$ind->id}}" rel="tooltip" class="btn btn-success" data-original-title="View Farmer" title="" target="_blank">
                                <i class="fa fa-eye" aria-hidden="true"></i>
                                <div class="ripple-container"></div>
                            </a>
                            <a href="{{url('/individual/edit')}}/{{$ind->id}}" rel="tooltip" class="btn btn-warning" data-original-title="Edit Farmer" title="" target="_blank">
 ...
 <!-- remember # refers to id tag and '.' refers to class -->
