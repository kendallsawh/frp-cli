    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                @endforeach()
                <h4 class="modal-title" id="flagModalLabel">Confirm Flagging of Application</h4>
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{route('flagServiceProvider')}}" id="flag_form" onSubmit="return flagChk()" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <div id="grp-flag_type" class="form-group{{ $errors->has('flag_type') ? ' has-error' : '' }} label-floating">
                                        <label class="control-label">Flag Type <span class="red">*</span></label>
           ...
           <div class="modal-footer">
            <button type="submit" class="btn btn-fill btn-danger" form="flag_form">Confirm</button>
