...
<div class="modal fade" id="ao1Modal" tabindex="-1" role="dialog" aria-labelledby="ao1ModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header text-center">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="ao1ModalLabel">Add AO1 data as {{Auth::user()->role_name}}</h4>
				<h5 class="description" id="ao1ModalLabel">You are about to add AO1 data for application: {{$data->id}}.</h5>

			</div>
			<div class="modal-body">


				<form method="POST" action="{{route('addApplicationComment')}}" id="addAO1Comment_form"  enctype="multipart/form-data">
					{{ csrf_field() }}
			...
			<div class="modal-footer">
				<button type="submit" class="btn btn-fill btn-success" form="addAO1Comment_form">Confirm</button>
