    ...
    <div class="tab-content">
        ...
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10" id="conf-job"></div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="submit" id="submit" class="btn btn-success pull-right loading-modal submit" form="cropMonitorForm">Submit</button>
                <a href="#wizard-navigation" type='button' class='btn btn-danger pull-right' id="edit">Edit</a>
            </div>
        </div>
    </div>
