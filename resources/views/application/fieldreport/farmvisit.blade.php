<div class="tab-pane" id="farmvisit">
    <div class="row nopadding">
        <div class="col-md-3 col-md-offset-4 nopadding">
            <a href="{{url('/application/cropmonitor/new/')}}/{{$current_parcel->id}}" type="button" id="editParcel" class="btn btn-success btn-round btn-sm btn-block" name="editParcel">Add New Crop Report <i class="fa fa-pencil"></i></a>
        </div>

    </div>
    
    <h4 class="info-text">Or edit last uploaded report</h4>
            ...
            <div class="card" >
                <!-- <div class="row">
                    <div class="col-sm-12">
                        <h4 class="info-text">
                            ...
                            <button type="button" class="btn btn-success btn-round btn-fab btn-fab-mini btn-add-crop" title="Add another crop/animal"  rel="tooltip" pane="1">
                ...
                <div class="card-header">
                  <a class="card-link" data-toggle="collapse" href="#collapse-{{$crop}}">
                    ...
                    <button type="button" class="btn btn-default btn-round btn-sm" title="Show or hide this crop information."  rel="tooltip"> Crop Item {{$crop}} Show/Hide {{$current_parcel->produce()->slice($crop-1,1)->first()->specific_parcel}}
                    </button>
                                        ...
                                        <div class="row" >
                                            ...
                                            <div class="col-md-2">
                                                <div id="grp-parcel_type_{{$crop}}" class="form-group{{ $errors->has('parcel_type.'.'.'.$crop) ? ' has-error' : '' }} label-floating">
                                                    ...
                                                    <input type="hidden" id="parcel_type_prod_id{{$crop}}" name="parcel_type_prod_id[{{$crop}}]" 
                                                    value="{{$crop-1!=0? $current_parcel->produce()->slice($crop-1,1)[$crop-1]['id']: $current_parcel->produce()->first()->id}}">
                                            ...
                                            <div class="col-md-2">
                                                    <div class="form-group{{ $errors->has('parcel_amt.'.$crop) ? ' has-error' : '' }} label-floating" id="grp-parcel_amt_{{$crop}}">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="parcel_amt_{{$crop}}" name="parcel_amt[{{$crop}}]" type="number" step="any" class="form-control parcel_amt" parcel="1" value="{{$crop-1==0 ? $current_parcel->produce()->first()->amt : $current_parcel->produce()->slice($crop-1,1)[$crop-1]['amt'] }}" min="0">
                                                ...
                                                <div class="col-md-2" style="padding-top: 20px">
                                                    <div class="input-group">
                                                        ...
                                                        <div id="grp-planting_date" class="form-group{{ $errors->has('planting_date') ? ' has-error' : '' }} label-floating">
                                                            ...
                                                            <input id="planting_date" name="planting_date[{{$crop}}]" type="text" class="form-control datepicker" autocomplete="off" value="{{Carbon\Carbon::today()->toDateString()}}">
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-62">
                    <div class="input-group">
                        ...
                        <div class="form-group{{ $errors->has('spacing') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="spacing" id="spacing" rows="2">{{old('spacing')}}</textarea>
                            ...
                            <span class="help-block text-danger">
                                <strong id="err-spacing">{{ $errors->first('spacing') }}</strong>
                            </span>
                        </div>
                    </div>
                </div>
