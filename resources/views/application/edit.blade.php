...
<div class="col-sm-12">
    ...
    <div class="wizard-container " id="wizard-container">
        <div class="card wizard-card" data-color="{{config('global.colour')}}" id="wizardProfile">
            ...
            <form role="form" method="POST" action="{{ route('postApplicationDataEdits') }}" id="farmerRegForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="tab-content">
                    @include('application.applicationedit.editenterprise')
                    @include('application.applicationedit.editparcels')
    ...
    <!-- wizard container -->
    @include('application.applicationedit.confirm')
