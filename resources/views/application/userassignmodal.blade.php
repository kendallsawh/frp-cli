    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" type = "hidden" action="{{url('/application/view/assign/')}}/{{$data->id}}/{{Auth::user()->id}}" id="assign_app_to_user" enctype="multipart/form-data">
                    {{ csrf_field() }}
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            @include('application.userassigntablerows')
                            @endforeach
