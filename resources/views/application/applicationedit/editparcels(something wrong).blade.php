            ...
            <div class="col-md-12 round-border-20 ">
                <div class="input-group">
                    ...
                    <div id="grp-app_type" class=" form-group{{ $errors->has('app_type') ? ' has-error' : '' }} label-floating">
                        <label class="control-label ">Application Type <span class="red">*</span> (This is used only as a reference for the land type and tenure and does not wholy affect the application)</label>
                    ...
                    <div class="col-sm-12 round-border-20" id="div-crops-{{$x}}">
                        ...
                        @if($current_parcel->produce()->count() == 1)
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="info-text">
                                        Type of Crops/Animals {{$current_parcel->produce()->first()->specific_parcel}}
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group{{ $errors->has('animal_crop.'.$x.'.1') ? ' has-error' : '' }} label-floating" id="grp-animal_crop_{{$x}}_1">
                                        ...
                                        <select id="animal_crop_{{$x}}_1" name="animal_crop[{{$x}}][1]" class="form-control dropdown animal_crop" parcel="{{$x}}" crop="1">
                                            ...
                                            <option value="{{$animal_crop->animal_crop}}" {{($current_parcel->produce()->first()->specific_parcel)==$animal_crop->animal_crop ? 'selected' : '' }}>{{$animal_crop->animal_crop}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group{{ $errors->has('animal_crop.'.$x.'.1') ? ' has-error' : '' }} label-floating" id="grp-animal_crop_{{$x}}_1">
                                    ...
                                    <select id="animal_crop_{{$x}}_1" name="animal_crop[{{$x}}][1]" class="form-control dropdown animal_crop" parcel="{{$x}}" crop="1">
                                        <option disabled="" selected=""></option>
                                        @foreach($animal_crops as $key=>$animal_crop)
                                        <option value="{{$animal_crop->animal_crop}}" {{old('animal_crop.'.$x.'.1')==++$key ? 'selected' : '' }}>{{$animal_crop->animal_crop}}</option>
                                        @endforeach
                                    </select>
