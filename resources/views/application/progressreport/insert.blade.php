...
<div class="col-sm-12">
    ...
    <div class="wizard-container " id="wizard-container">
        <div class="card wizard-card" data-color="{{config('global.colour')}}" id="wizardProfile">
            ...
            <form role="form" method="POST" action="{{ route('cropMonitorInsert') }}" id="cropMonitorForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="tab-content">
                    @include('application.progressreport.progressform')
    ...
    <!-- wizard container -->
    @include('application.progressreport.confirm')
...
@section('scripts')
    <script type="text/javascript">
          // validation
    @include('application.progressreport.validation')

    // common scripts
    @include('application.progressreport.scripts')
