            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        <td>Caroni</td>
                        <td>
                            <a href="{{url('reports/cso_listing')}}/1/0" type="button" id="reference" class="btn btn-success btn-round btn-xs " name="reference">
                            <i class="fa fa-file-text-o" aria-hidden="true"></i> View FRP List</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('reports/cso_listing')}}/4/0" type="button" id="reference" class="btn btn-success btn-round btn-xs " name="reference">
                            <i class="fa fa-file-text-o" aria-hidden="true"></i> View FRP List</a>
                        ...
                        <td>
                            ...
                            <a href="{{asset('/storage/usermanual/RAN/STAD.xlsx')}}" type="button" id="reference" class="btn btn-primary btn-round btn-xs " name="reference">
                            <i class="fa fa-file-text-o" aria-hidden="true"></i> Download as Excel</a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('reports/cso_listing')}}/6/0" type="button" id="reference" class="btn btn-success btn-round btn-xs " name="reference">
                            <i class="fa fa-file-text-o" aria-hidden="true"></i> View FRP List</a>
                        ...
                        <td>
                            ...
                            <a href="{{asset('/storage/usermanual/RAN/STGE.xlsx')}}" type="button" id="reference" class="btn btn-primary btn-round btn-xs " name="reference">
                            <i class="fa fa-file-text-o" aria-hidden="true"></i> Download as Excel</a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('reports/cso_listing')}}/10/0" type="button" id="reference" class="btn btn-success btn-round btn-xs " name="reference">
                            <i class="fa fa-file-text-o" aria-hidden="true"></i> View FRP List</a>
                        ...
                        <td>
                            ...
                            <a href="{{asset('/storage/usermanual/RAN/STGW.xlsx')}}" type="button" id="reference" class="btn btn-primary btn-round btn-xs " name="reference">
                            <i class="fa fa-file-text-o" aria-hidden="true"></i> Download as Excel</a>
                        </td>
