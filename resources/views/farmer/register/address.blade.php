            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div id="grp-street_number2" class="form-group{{ $errors->has('street_number2') ? ' has-error' : '' }} label-floating">
                        ...
                        <input id="street_number2" name="street_number2" type="text" class="form-control" value="{{old('street_number2')}}" style="text-transform:uppercase">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div id="grp-road_trace2" class="form-group{{ $errors->has('road_trace2') ? ' has-error' : '' }} label-floating">
                        ...
                        <input id="road_trace2" name="road_trace2" type="text" class="form-control" value="{{old('road_trace2')}}" style="text-transform:uppercase">
