<div class="tab-pane" id="parcels"  target="appointment">
    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="info-text">
                    Information on Holdings Farmed/ Utilized
                    <button type="button" class="btn btn-success btn-round btn-fab btn-fab-mini hide" title="Add another parcel"  rel="tooltip" id="btn-add-parcel">
            ...
            <div class="col-md-12 round-border-20">
                <div class="input-group">
                    ...
                    <div id="grp-app_type" class="form-group{{ $errors->has('app_type') ? ' has-error' : '' }} label-floating">
                        <label class="control-label">Application-Holding Type <span class="red">*</span></label>
            ...
            <div class="parcel-pane {{$x==1? '' : 'hide'}}" id="parcel-pane-{{$x}}">
                <div class="row">
                    <div class="col-sm-12 round-border-20">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="info-text">
                                    Holdings Address <i><small>(Parcel {{$x}})</small></i> 
                                    @if($x !== 1)
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="checkbox">
                                    <label>
                                        <input id="parcel_reg_checkbox_{{$x}}" type="checkbox" name="parcel_reg_checkbox[{{$x}}]" {{old('parcel_reg_checkbox.'.$x)=='on' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="info-text hide county_check" id="county_check">
                                    Application will be registered under
                                </h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 round-border-20">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div id="grp-land_type_{{$x}}" class="form-group{{ $errors->has('land_type.'.$x) ? ' has-error' : '' }} label-floating">
                                    ...
                                    <select id="land_type_{{$x}}" name="land_type[{{$x}}]" class="form-control dropdown land_type" parcel="{{$x}}" onchange="getval(this);">
                                        <option disabled="" selected=""></option>
                        ...
                        <div class="hide row" id="uprn_row">
                            <div class="col-sm-6">
                                <div id="grp-uprns_{{$x}}" class="form-group{{ $errors->has('uprns.'.$x) ? ' has-error' : '' }} label-floating">
                                    <label class="control-label">Please Enter UPRN/UPRS(If State Land)  </label>
                                    
                                    <input id="uprns_{{$x}}" name="uprns[{{$x}}]" type="text" class="form-control uprns" parcel="{{$x}}" value="{{old('uprns.'.$x)}}" style="text-transform:uppercase">
                                    
                                    <span class="help-block">
                                        <strong id="err-uprns_{{$x}}">{{ $errors->first('uprns.'.$x) }}</strong>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 round-border-20">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <h5 class="info-text">
                                    If multiple files exist for a particular proof, select all of those files in the upload dialogue<br>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group{{ $errors->has('animal_crop.'.$x.'.1') ? ' has-error' : '' }} label-floating" id="grp-animal_crop_{{$x}}_1">
                                    ...
                                    <select id="animal_crop_{{$x}}_1" name="animal_crop[{{$x}}][1]" class="form-control dropdown animal_crop" parcel="{{$x}}" crop="1">
                                        ...
                                        <option value="{{$animal_crop->id}}" {{old('animal_crop.'.$x.'.1')==$animal_crop->id ? 'selected' : '' }}>{{$animal_crop->CommodityLocalName}}({{$animal_crop->Variety}})</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row vertical-divider">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group{{ $errors->has('animal_crop.'.$x.'.'.$crop) ? ' has-error' : '' }} label-floating" id="grp-animal_crop_{{$x}}_{{$crop}}">
                                        ...
                                        <option disabled="" selected=""></option>
                                        @foreach($animal_crops as $key=>$animal_crop)
                                        <option value="{{$animal_crop->id}}" {{old('animal_crop.'.$x.'.'.$crop)==$animal_crop->id ? 'selected' : '' }}>{{$animal_crop->CommodityLocalName}}({{$animal_crop->Variety}})</option>
                                        @endforeach
                                    </select>
                                        <span class="help-block">
                ...
                <!-- <div class="row round-border-20">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div id="grp-appointment{{$x}}" class="form-group{{ $errors->has('appointment.'.$x) ? ' has-error' : '' }} label-floating">
                                    ...
                                    <span class="help-block">
                                        ...
                                        <strong id="err-appointment{{$x}}">{{ $errors->first('appointment.'.$x) }}</strong>
                                    </span>
                                </div>
                            </div>
                            <div class="col-sm-4">
