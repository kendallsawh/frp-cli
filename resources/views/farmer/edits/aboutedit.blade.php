            ...
            <div class="row round-border-20">
                <div class = "row">
                    <div class="col-sm-12">
                        ...
                        <p class="text-center">Previous Farmer Badge Information</p>
                    ...
                    <div class="col-sm-5">
                        <div class="input-group ">
                            ...
                            <div id="grp-oldregistration" class="form-group{{ $errors->has('oldregistration') ? ' has-error' : '' }} label-floating">
                                <label class="control-label">Last Badge Number(AAAA/xxxx/xxxx) </label>
                                <input id="oldregistration" name="oldregistration" type="text" class="form-control oldregistration" value="{{$userdata->farmer()? ($userdata->farmer()->badge()? ($userdata->farmer()->badge()->old_badge_id? $userdata->farmer()->badge()->old_badge_id:''):''):''}}">
                    ...
                    <div class="col-sm-7">
                        <div class="input-group">
                            ...
                            <div id="grp-dateofissue" class="form-group{{ $errors->has('dateofissue') ? ' has-error' : '' }} label-floating">
                                    ...
                                    <input id="dateofissue" name="dateofissue" type="text" class="form-control datepicker" autocomplete="off" value="{{$userdata->farmer()? ($userdata->farmer()->badge()? ($userdata->farmer()->badge()->date_issued? $userdata->farmer()->badge()->date_issued: '1900-01-01'): '1900-01-01'):'1900-01-01'}}">
            ...
            <div class="input-group">
                ...
                <div id="grp-n_id" class="form-group{{ $errors->has('n_id') ? ' has-error' : '' }} label-floating">
                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-9">
                        ...
                        <input id="n_id" name="n_id" type="number" onblur="duplicateN_id(this)" class="form-control" value="{{$userdata->nationalid? $userdata->nationalid : '' }}" autocomplete="false" style="text-transform:uppercase">
                    </div>
