                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div id="grp-parcel_street_number_{{$x}}" class="form-group{{ $errors->has('parcel_street_number.'.$x) ? ' has-error' : '' }} label-floating">
                                    ...
                                    <input id="parcel_street_number_{{$x}}" name="parcel_street_number[{{$x}}]" type="text" class="form-control parcel_street_number" parcel="{{$x}}" value="{{old('parcel_street_number.'.$x)}}">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div id="grp-parcel_road_trace_{{$x}}" class="form-group{{ $errors->has('parcel_road_trace.'.$x) ? ' has-error' : '' }} label-floating">
                                    ...
                                    <input id="parcel_road_trace_{{$x}}" name="parcel_road_trace[{{$x}}]" type="text" class="form-control parcel_road_trace" parcel="{{$x}}" value="{{old('parcel_road_trace.'.$x)}}">
                        ...
                        <div class="row vertical-divider">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group{{ $errors->has('animal_crop.'.$x.'.1') ? ' has-error' : '' }} label-floating" id="grp-animal_crop_{{$x}}_1">
                                    ...
                                    <input id="animal_crop_{{$x}}_1" name="animal_crop[{{$x}}][1]" type="text" class="form-control animal_crop" parcel="{{$x}}" value="{{old('animal_crop.'.$x.'.1')}}">
                                ...
                                <div class="row vertical-divider">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group{{ $errors->has('animal_crop.'.$x.'.'.$crop) ? ' has-error' : '' }} label-floating" id="grp-animal_crop_{{$x}}_{{$crop}}">
                                            <label class="control-label">Specific Crop/Animal <span class="red">*</span></label>
                                            <input id="animal_crop_{{$x}}_{{$crop}}" name="animal_crop[{{$x}}][{{$crop}}]" type="text" class="form-control animal_crop" parcel="{{$x}}" value="{{old('animal_crop.'.$x.'.'.$crop)}}">
