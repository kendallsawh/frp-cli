    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div id="grp-hometype" class="form-group{{ $errors->has('hometype') ? ' has-error' : '' }} label-floating">
                    ...
                    <select id="hometype" name="hometype" class="form-control dropdown">
                        ...
                        <option value="{{$lot_type->id}}" {{$userdata->home()->lot_type->id==$lot_type->id ? 'selected' : '' }}>{{$lot_type->lot_type}}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-sm-6">
                <div id="grp-street_number" class="form-group{{ $errors->has('street_number') ? ' has-error' : '' }} label-floating">
                    ...
                    <input id="street_number" name="street_number" type="text" class="form-control" value="{{$userdata->home()->house_num}}">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div id="grp-road_trace" class="form-group{{ $errors->has('road_trace') ? ' has-error' : '' }} label-floating">
                    <label class="control-label">Road/Street/Trace Name </label>
                    <input id="road_trace" name="road_trace" type="text" class="form-control" value="{{$userdata->home()->road}}">
            ...
            <div class="col-sm-12">
                <div id="grp-town_village" class="form-group{{ $errors->has('town_village') ? ' has-error' : '' }} label-floating">
                    ...
                    <select id="town_village" name="town_village" class="form-control dropdown">
                        ...
                        <option value="{{$district->id}}" {{$userdata->home()->district->id==$district->id ? 'selected' : '' }}>{{$district->district}}</option>
                        @endforeach
                    </select>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="checkbox">
                    <label>
                        <input id="postal_checkbox" type="checkbox" name="postal_checkbox"  {{$userdata->postal() ? '' : 'checked' }}>
                        Same as above?
                    </label>
                </div>
            </div>
        ...
        <div id="postal-address-div" style="{{$userdata->postal() ? 'display:none' : '' }}">
            <div class="row">
                <div class="col-sm-6">
                    <div id="grp-postaltype" class="form-group{{ $errors->has('postaltype') ? ' has-error' : '' }} label-floating">
                        ...
                        <select id="postaltype" name="postaltype" class="form-control dropdown">
                            <option disabled="" selected=""></option>
                            @foreach($lot_types as $lot_type)
                            <option value="{{$lot_type->id}}" {{$userdata->postal()? ($userdata->postal()->lot_type->id==$lot_type->id ? 'selected' : '') : '' }}>{{$lot_type->lot_type}}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-sm-6">
                    <div id="grp-street_number2" class="form-group{{ $errors->has('street_number2') ? ' has-error' : '' }} label-floating">
                        ...
                        <input id="street_number2" name="street_number2" type="text" class="form-control" value="{{$userdata->postal()? ($userdata->postal()->house_num) : ''}}">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div id="grp-road_trace2" class="form-group{{ $errors->has('road_trace2') ? ' has-error' : '' }} label-floating">
                        ...
                        <input id="road_trace2" name="road_trace2" type="text" class="form-control" value="{{$userdata->postal()? ($userdata->postal()->road) : ''}}">
                ...
                <div class="col-sm-12">
                    <div id="grp-town_village2" class="form-group{{ $errors->has('town_village2') ? ' has-error' : '' }} label-floating">
                        ...
                        <select id="town_village2" name="town_village2" class="form-control dropdown">
                            <option disabled="" selected=""></option>
                            @foreach($districts as $district)
                            <option value="{{$district->id}}" {{$userdata->postal()? ($userdata->postal()->district->id==$district->id ? 'selected' : '') : '' }}>{{$district->district}}</option>
                            @endforeach
                        </select>
