    ...
    /*
    |
    | clear error status and add confirm data to confirm panel
    |
    */
    ...
    $(document).on('change', '.form-control', function() {
        ...
        $('#err-'+id).html('');
        //add confirm data here.. 
        //id is the id name from the id property in the input fields of the main form
    ...
    $(document).on('click', '.btn-add-crop', function() {
        ...
        var nextCrop = parseInt(cropNum, 10)+1;
        
        $("#div-crops-"+pane).append('@include("farmer.register.parcel.newcrop_edit_app")');
