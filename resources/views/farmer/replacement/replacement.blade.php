        ...
        <div class="card wizard-card" data-color="{{config('global.colour')}}" id="wizardProfile">
            ...
            <!--  {{ csrf_field() }} -->
                <div class="wizard-header">
                    <h2 class="wizard-title">Replacement</h2>
                    ...
                    <div class="wizard-navigation hidden-xs hidden-sm">
                        <ul>
                            ...
                            <li><a href="#address" tab="address" data-toggle="tab">Reason</a></li>
                            <li><a href="#confirmation" tab="confirmation" data-toggle="tab">Confirmation</a></li>
                        </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="address" target="confirmation">
                            <div class="col-sm-12 round-border">
                                <div class="form-group has-error">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="checkbox">
                                                <label>What happened to your Farmer ID?</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2 engage-level" id="">
                                            <div class="radio">
                                                <label class="" for="lost">
                                                    <input id="lost" type="radio" name="lost_mut" value="lost" class="majorminor" <span class="circle"></span><span class="check"></span> Lost
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2 engage-level" id="">
                                            <div class="radio">
                                                <label class="" for="mutulated">
                                                    <input id="mutulated" type="radio" name="lost_mut" value="mutulated" class="majorminor"> <span class="circle"></span><span class="check"></span> Mutulated
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 round-border" style="min-height: 110px">
                                        <label>Please submit a police report of your lost Farmer's ID.</label><input class="form-group" name='lost' type="file" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="confirmation">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <h5 style="font-weight:bold;">Reason For Replacement:</h5>
                                </div>
                                <div class="col-sm-8">
                                    <h5><i class="material-icons">question_answer</i>Lost</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                    <h5 style="font-weight:bold;">Police Report:</h5>
                                </div>
                                <div class="col-sm-8">
                                    <h5><i class="material-icons">picture_as_pdf</i>police_report.pdf</h5>
                                </div>
                            </div>
                        </div>
                    </div>
