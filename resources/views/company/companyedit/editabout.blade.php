        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <div id="grp-org_name" class="form-group{{ $errors->has('org_name') ? ' has-error' : '' }} label-floating">
                    ...
                    <input id="org_name" name="org_name" type="text" class="form-control" value="{{old('org_name')? old('org_name') : $company->organization_name}}"/>
            ...
            <div class="input-group">
                ...
                <div id="grp-org_type" class="form-group{{ $errors->has('org_type') ? ' has-error' : '' }} label-floating">
                    ...
                    <input id="org_type" name="org_type" type="text" class="form-control" value="{{old('org_type')? old('org_type') : $company->organization_type}}"/>
            ...
            <div class="input-group">
                ...
                <div id="grp-reg_num" class="form-group{{ $errors->has('reg_num') ? ' has-error' : '' }} label-floating">
                    ...
                    <input id="reg_num" name="reg_num" type="number" class="form-control" value="{{old('reg_num')? old('reg_num'): $company->registration_num}}"/>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="input-group">
                        ...
                        <div id="grp-vat_num" class="form-group{{ $errors->has('vat_num') ? ' has-error' : '' }} label-floating">
                            ...
                            <input id="vat_num" name="vat_num" type="number" class="form-control" value="{{old('vat_num')? old('vat_num') : $company->vat_reg_num}}"/>
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        ...
                        <div id="grp-biz_email" class="form-group{{ $errors->has('biz_email') ? ' has-error' : '' }} label-floating">
                            ...
                            <input id="biz_email" name="biz_email" type="email" class="form-control" value="{{old('biz_email')? old('biz_email') : ($company->email? $company->email: '')}}"/>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="input-group">
                        ...
                        <div id="grp-biz_phone" class="form-group{{ $errors->has('biz_phone') ? ' has-error' : '' }} label-floating">
                            ...
                            <input id="biz_phone" name="biz_phone" type="text" class="form-control contact" value="{{old('biz_phone')? old('biz_phone'): $company->contact->contact}}" autocomplete="false">
