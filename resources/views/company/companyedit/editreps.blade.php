        ...
        <div class="col-sm-6">
            ...
            <div class="input-group">
                ...
                <div id="grp-app_fname{{$i}}" class="form-group{{ $errors->has('app_fname'.$i) ? ' has-error' : '' }} label-floating">
                    ...
                    <input id="app_fname{{$i}}" name="app_fname{{$i}}" type="text" class="form-control" value="{{old('app_fname'.$i)}}"/>
            ...
            <div class="input-group">
                ...
                <div id="grp-app_sname{{$i}}" class="form-group{{ $errors->has('app_sname'.$i) ? ' has-error' : '' }} label-floating">
                    ...
                    <input id="app_sname{{$i}}" name="app_sname{{$i}}" type="text" class="form-control" value="{{old('app_sname'.$i)}}"/>
