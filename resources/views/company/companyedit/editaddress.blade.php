                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div id="grp-hometype" class="form-group{{ $errors->has('hometype') ? ' has-error' : '' }} label-floating">
                            ...
                            <select id="hometype" name="hometype" class="form-control dropdown">
                                ...
                                <option value="{{$lot_type->id}}" {{$company->address->lot_type_id ? 'selected' : '' }}>{{$lot_type->lot_type}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-6">
                        <div id="grp-street_number" class="form-group{{ $errors->has('street_number') ? ' has-error' : '' }} label-floating">
                            ...
                            <input id="street_number" name="street_number" type="text" class="form-control" value="{{old('street_number')? old('street_number'): ($company->address? $company->address->house_num : '')}}">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div id="grp-road_trace" class="form-group{{ $errors->has('road_trace') ? ' has-error' : '' }} label-floating">
                            ...
                            <input id="road_trace" name="road_trace" type="text" class="form-control" value="{{old('road_trace')? old('road_trace'): ($company->address? $company->address->road: '')}}">
                    ...
                    <div class="col-sm-12">
                        <div id="grp-town_village" class="form-group{{ $errors->has('town_village') ? ' has-error' : '' }} label-floating">
                            ...
                            <select id="town_village" name="town_village" class="form-control dropdown">
                                ...
                                <option value="{{$district->id}}" {{$company->address->district_id==$district->id ? 'selected' : '' }}>{{$district->district}}</option>
                                @endforeach
                            </select>
